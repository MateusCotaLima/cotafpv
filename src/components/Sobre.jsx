        ...
        <div class="Areas">
            <div class="cardsSobre">
                <div class="tituloSobre">
                    ...
                    <h1>Sobre Mim</h1>
                    <p>Olá, meu nome é Mateus Cota, Sou de Rio Piraciba MG, atualmente estou morando em Itabira MG cursando Engenharia de Computação na Unifei. Comecei a estudar sobre os Drones FPV a alguns anos atrás e finalmente este ano tive a condição de investir neste sonho de fazer belas imagens aéreas.</p>
